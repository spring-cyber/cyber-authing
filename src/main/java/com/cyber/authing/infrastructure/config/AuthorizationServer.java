...
import com.cyber.authing.domain.userdetails.user.SysUserDetails;
import com.cyber.authing.domain.userdetails.user.SysUserDetailsServiceImpl;
import com.cyber.authing.infrastructure.granter.captcha.CaptchaTokenGranter;
import com.cyber.authing.infrastructure.granter.mobile.SmsCodeTokenGranter;
import com.cyber.authing.infrastructure.granter.refresh.PreAuthenticatedUserDetailsService;
...
public class AuthorizationServer extends AuthorizationServerConfigurerAdapter {
    ...
    public TokenEnhancer tokenEnhancer() {
        return (accessToken, authentication) -> {
            ...
            if (principal instanceof SysUserDetails) {
                ...
                additionalInfo.put("authorities", sysUserDetails.getRoles());
                // 认证身份标识(username:用户名；)
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, e) -> {
            ...
            Response result = Response.fail(HttpResultCode.BAD_AUTH);
