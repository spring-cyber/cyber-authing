 ...
 * @since 1.13.0
 */
public class AuthingTwitterRequest extends AuthingDefaultRequest {

    private static final String PREAMBLE = "OAuth";

    public AuthingTwitterRequest(AuthConfig config) {
        super(config, TWITTER);
    }

    public AuthingTwitterRequest(AuthConfig config, AuthStateCache authStateCache) {
