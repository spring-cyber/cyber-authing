 ...
 * @since 1.3.0
 */
public class AuthingGoogleRequest extends AuthingDefaultRequest {

    public AuthingGoogleRequest(AuthConfig config) {
        super(config, AuthDefaultSource.GOOGLE);
    }

    public AuthingGoogleRequest(AuthConfig config, AuthStateCache authStateCache) {
