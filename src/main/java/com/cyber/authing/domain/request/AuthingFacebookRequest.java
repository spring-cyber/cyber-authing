 ...
 * @since 1.3.0
 */
public class AuthingFacebookRequest extends AuthingDefaultRequest {

    public AuthingFacebookRequest(AuthConfig config) {
        super(config, AuthDefaultSource.FACEBOOK);
    }

    public AuthingFacebookRequest(AuthConfig config, AuthStateCache authStateCache) {
