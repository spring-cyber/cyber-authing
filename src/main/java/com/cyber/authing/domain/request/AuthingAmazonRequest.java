 ...
 * @since 1.16.0
 */
public class AuthingAmazonRequest extends AuthingDefaultRequest {

    public AuthingAmazonRequest(AuthConfig config) {
        super(config, AuthDefaultSource.AMAZON);
    }

    public AuthingAmazonRequest(AuthConfig config, AuthStateCache authStateCache) {
