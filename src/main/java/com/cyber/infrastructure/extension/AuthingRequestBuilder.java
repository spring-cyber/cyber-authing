 ...
 * @since 1.16.3
 */
public class AuthingRequestBuilder {
    private String source;
    private AuthConfig authConfig;
    private AuthStateCache authStateCache;
    private AuthSource[] extendSource;

    private AuthingRequestBuilder() {

    }

    public static AuthingRequestBuilder builder() {
        return new AuthingRequestBuilder();
    }

    public AuthingRequestBuilder source(String source) {
        this.source = source;
        return this;
    }

    public AuthingRequestBuilder authConfig(AuthConfig authConfig) {
        this.authConfig = authConfig;
        return this;
    }

    public AuthingRequestBuilder authConfig(Function<String, AuthConfig> authConfig) {
        this.authConfig = authConfig.apply(this.source);
        return this;
    }

    public AuthingRequestBuilder authStateCache(AuthStateCache authStateCache) {
        this.authStateCache = authStateCache;
        return this;
    }

    public AuthingRequestBuilder extendSource(AuthSource... extendSource) {
